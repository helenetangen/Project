...
In this chapter the wind farm layout optimization problem will be defined and explained in section \ref{section:wflop}. Section \ref{section:ga} is partitioned into two subsections. In \ref{subsection:sga} the simple genetic algorithm is explain, and in \ref{subsection:dga} the seven distributed genetic algorithms that will be implemented in this thesis are described. 
