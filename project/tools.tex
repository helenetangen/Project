...
% Implement different distributed genetic algorithms.
% Run simulations to figure out which one is the best, get answer to research questions.
% Might also do some changes to the genetic algorithm.
