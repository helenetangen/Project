...
\begin{figure}[h!]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \caption{}
    \end{subfigure}
    \caption{Minimum-, maximum-, and average fitness for two scenarios provided by GECCO; (a) Fitness for scenario 1, without obstacles, (b) Fitness for scenario 1 with obstacles.}
    \label{Hybrid Models}
\end{figure}
